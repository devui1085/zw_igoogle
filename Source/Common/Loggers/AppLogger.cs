...
namespace Common.Loggers
{
    public class AppLogger
    {
        ...
        public static void Debug(string message, Exception ex, string controllerName, string actionName)
        {
            logger.Debug(FormatLogEntry(message, controllerName, actionName), ex);
        }

        public static void Info(string message, Exception ex, string controllerName, string actionName)
        {
            logger.Info(FormatLogEntry(message, controllerName, actionName), ex);
        }

        public static void Warn(string message, Exception ex, string controllerName, string actionName)
        {
            logger.Warn(FormatLogEntry(message, controllerName, actionName), ex);
        }

        public static void Error(string message, Exception ex, string controllerName, string actionName)
        {
            logger.Error(FormatLogEntry(message, controllerName, actionName), ex);
        }

        public static void Fatal(string message, Exception ex, string controllerName, string actionName)
        {
